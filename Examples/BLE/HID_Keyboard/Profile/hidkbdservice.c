...
static gattCharCfg_t hidReportKeyInClientCharCfg[PERIPHERAL_MAX_CONNECTION+1];
...
static gattCharCfg_t hidReportBootKeyInClientCharCfg[PERIPHERAL_MAX_CONNECTION+1];
